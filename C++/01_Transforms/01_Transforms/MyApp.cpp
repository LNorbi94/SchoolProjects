...
void CMyApp::Update()
{
	...
	m_matView = glm::lookAt(glm::vec3( 3,  3,  5),		// honnan nézzük a színteret
...
void CMyApp::Render()
{
	...
	for (int i = 0; i < 5; ++i)
	{
		m_matWorld	= glm::rotate<float>(360 / 5.0 * i, 0, 1, 0)
					* glm::translate<float>(5, 0, 0)
					* glm::rotate<float>( SDL_GetTicks() / 2000.0 * 360, 0, 1, 0);
